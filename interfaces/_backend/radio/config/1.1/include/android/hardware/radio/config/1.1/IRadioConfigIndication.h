#ifndef HIDL_GENERATED_ANDROID_HARDWARE_RADIO_CONFIG_V1_1_IRADIOCONFIGINDICATION_H
#define HIDL_GENERATED_ANDROID_HARDWARE_RADIO_CONFIG_V1_1_IRADIOCONFIGINDICATION_H
 ...
 */
struct IRadioConfigIndication : public ::android::hardware::radio::config::V1_0::IRadioConfigIndication {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.radio.config@1.1::IRadioConfigIndication"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::config::V1_1::IRadioConfigIndication>> castFrom(const ::android::sp<::android::hardware::radio::config::V1_1::IRadioConfigIndication>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::config::V1_1::IRadioConfigIndication>> castFrom(const ::android::sp<::android::hardware::radio::config::V1_0::IRadioConfigIndication>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::config::V1_1::IRadioConfigIndication>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::config::V1_1::IRadioConfigIndication>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::config::V1_1::IRadioConfigIndication>& o) {
    ...
    os += ::android::hardware::radio::config::V1_1::IRadioConfigIndication::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_RADIO_CONFIG_V1_1_IRADIOCONFIGINDICATION_H
