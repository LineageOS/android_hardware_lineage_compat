...
struct IRadioConfig : public ::android::hardware::radio::config::V1_0::IRadioConfig {
    ...
    /**
     * Fully qualified interface name: "lineage.hardware.radio.config@1.1::IRadioConfig"
     */
     ...
     */
    virtual ::android::hardware::Return<void> setResponseFunctions(const ::android::sp<::android::hardware::radio::config::V1_0::IRadioConfigResponse>& radioConfigResponse, const ::android::sp<::android::hardware::radio::config::V1_0::IRadioConfigIndication>& radioConfigIndication) override = 0;
     ...
     */
    virtual ::android::hardware::Return<void> getSimSlotsStatus(int32_t serial) override = 0;
     ...
     */
    virtual ::android::hardware::Return<void> setSimSlotsMapping(int32_t serial, const ::android::hardware::hidl_vec<uint32_t>& slotMap) override = 0;
