...
struct IRadioConfigIndication : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "lineage.hardware.radio.config@1.0::IRadioConfigIndication"
     */
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::config::V1_0::IRadioConfigIndication>& o);
