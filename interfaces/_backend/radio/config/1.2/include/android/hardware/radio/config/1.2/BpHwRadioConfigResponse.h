#ifndef HIDL_GENERATED_ANDROID_HARDWARE_RADIO_CONFIG_V1_2_BPHWRADIOCONFIGRESPONSE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_RADIO_CONFIG_V1_2_BPHWRADIOCONFIGRESPONSE_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/radio/config/1.2/IHwRadioConfigResponse.h>
...
struct BpHwRadioConfigResponse : public ::android::hardware::BpInterface<IRadioConfigResponse>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_getSimSlotsStatusResponse_1_2(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::android::hardware::hidl_vec<::android::hardware::radio::config::V1_2::SimSlotStatus>& slotStatus);
    ...
    // Methods from ::android::hardware::radio::config::V1_2::IRadioConfigResponse follow.
    ::android::hardware::Return<void> getSimSlotsStatusResponse_1_2(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::android::hardware::hidl_vec<::android::hardware::radio::config::V1_2::SimSlotStatus>& slotStatus) override;
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_RADIO_CONFIG_V1_2_BPHWRADIOCONFIGRESPONSE_H
