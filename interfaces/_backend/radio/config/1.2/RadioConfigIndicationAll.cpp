#define LOG_TAG "android.hardware.radio.config@1.2::RadioConfigIndication"
...
#include <android/hardware/radio/config/1.2/BpHwRadioConfigIndication.h>
#include <android/hardware/radio/config/1.2/BnHwRadioConfigIndication.h>
#include <android/hardware/radio/config/1.2/BsRadioConfigIndication.h>
...
// no default implementation for: ::android::hardware::Return<void> IRadioConfigIndication::simSlotsStatusChanged_1_2(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_vec<::android::hardware::radio::config::V1_2::SimSlotStatus>& slotStatus)

// Methods from ::android::hidl::base::V1_0::IBase follow.
::android::hardware::Return<void> IRadioConfigIndication::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::radio::config::V1_2::IRadioConfigIndication::descriptor,
...
::android::hardware::Return<void> IRadioConfigIndication::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::radio::config::V1_2::IRadioConfigIndication::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IRadioConfigIndication::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){176,212,82,249,162,228,95,128,189,182,114,177,228,203,100,159,255,80,41,59,223,32,128,153,190,65,115,143,17,205,46,173} /* b0d452f9a2e45f80bdb672b1e4cb649fff50293bdf208099be41738f11cd2ead */,
...
::android::hardware::Return<::android::sp<::android::hardware::radio::config::V1_2::IRadioConfigIndication>> IRadioConfigIndication::castFrom(const ::android::sp<::android::hardware::radio::config::V1_2::IRadioConfigIndication>& parent, bool /* emitError */) {
    return parent;
}
...
BpHwRadioConfigIndication::BpHwRadioConfigIndication(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IRadioConfigIndication>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.radio.config@1.2", "IRadioConfigIndication") {
}
...
// Methods from ::android::hardware::radio::config::V1_2::IRadioConfigIndication follow.
::android::hardware::Return<void> BpHwRadioConfigIndication::_hidl_simSlotsStatusChanged_1_2(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_vec<::android::hardware::radio::config::V1_2::SimSlotStatus>& slotStatus) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadioConfigIndication::simSlotsStatusChanged_1_2::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio.config", "1.2", "IRadioConfigIndication", "simSlotsStatusChanged_1_2", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(2 /* simSlotsStatusChanged_1_2 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio.config", "1.2", "IRadioConfigIndication", "simSlotsStatusChanged_1_2", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::radio::config::V1_2::IRadioConfigIndication follow.
::android::hardware::Return<void> BpHwRadioConfigIndication::simSlotsStatusChanged_1_2(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_vec<::android::hardware::radio::config::V1_2::SimSlotStatus>& slotStatus){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::config::V1_2::BpHwRadioConfigIndication::_hidl_simSlotsStatusChanged_1_2(this, this, type, slotStatus);
...
BnHwRadioConfigIndication::BnHwRadioConfigIndication(const ::android::sp<IRadioConfigIndication> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.radio.config@1.2", "IRadioConfigIndication") { 
...
// Methods from ::android::hardware::radio::config::V1_2::IRadioConfigIndication follow.
::android::status_t BnHwRadioConfigIndication::_hidl_simSlotsStatusChanged_1_2(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadioConfigIndication::simSlotsStatusChanged_1_2::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&type);
        _hidl_args.push_back((void *)slotStatus);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio.config", "1.2", "IRadioConfigIndication", "simSlotsStatusChanged_1_2", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadioConfigIndication*>(_hidl_this->getImpl().get())->simSlotsStatusChanged_1_2(type, *slotStatus);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio.config", "1.2", "IRadioConfigIndication", "simSlotsStatusChanged_1_2", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadioConfigIndication::onTransact(
    ...
    switch (_hidl_code) {
        ...
        case 2 /* simSlotsStatusChanged_1_2 */:
        {
            _hidl_err = ::android::hardware::radio::config::V1_2::BnHwRadioConfigIndication::_hidl_simSlotsStatusChanged_1_2(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsRadioConfigIndication::BsRadioConfigIndication(const ::android::sp<::android::hardware::radio::config::V1_2::IRadioConfigIndication> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.radio.config@1.2", "IRadioConfigIndication"), mImpl(impl) {
