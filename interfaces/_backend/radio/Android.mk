...
_shim_hidl_library_name     := lineage.abi_shim.radio
_frontend_hidl_package_name := android.hardware.radio
_backend_hidl_package_name  := lineage.hardware.radio
_frontend_hidl_interface_name   := IRadio
...
$(eval $(call _shim_hidl_library_template,1.4))
$(eval $(call _shim_hidl_library_template,1.5))
$(eval $(call _shim_hidl_library_template,1.6))
