...
namespace audio {
namespace core {
class IBluetoothLeDelegator;

class IBluetoothLe : public ::ndk::ICInterface {
public:
  typedef IBluetoothLeDelegator DefaultDelegator;
  static const char* descriptor;
  IBluetoothLe();
  virtual ~IBluetoothLe();
  ...
  static std::shared_ptr<IBluetoothLe> fromBinder(const ::ndk::SpAIBinder& binder);
  static binder_status_t writeToParcel(AParcel* parcel, const std::shared_ptr<IBluetoothLe>& instance);
  static binder_status_t readFromParcel(const AParcel* parcel, std::shared_ptr<IBluetoothLe>* instance);
  static bool setDefaultImpl(const std::shared_ptr<IBluetoothLe>& impl);
  static const std::shared_ptr<IBluetoothLe>& getDefaultImpl();
...
private:
  static std::shared_ptr<IBluetoothLe> default_impl;
};
class IBluetoothLeDefault : public IBluetoothLe {
public:
