...
public:
  ...
  public:
    ...
    template <typename _Tp, typename = std::enable_if_t<
        _not_self<_Tp> &&
        std::is_constructible_v<std::variant<::aidl::android::hardware::audio::effect::VendorExtension, ::aidl::android::hardware::audio::effect::AutomaticGainControlV2::Tag>, _Tp>
      >>
  ...
  template <typename _Tp, typename = std::enable_if_t<
      _not_self<_Tp> &&
      std::is_constructible_v<std::variant<::aidl::android::hardware::audio::effect::VendorExtension, int32_t, ::aidl::android::hardware::audio::effect::AutomaticGainControlV2::LevelEstimator, int32_t>, _Tp>
    >>
  // NOLINTNEXTLINE(google-explicit-constructor)
