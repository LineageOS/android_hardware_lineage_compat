 ...
 * Using: out/host/linux-x86/bin/aidl --lang=ndk --structured --version 5 --hash 3ac4a1539dc76abf25f2ade699ee17ba036d7729 -t --stability vintf --min_sdk_version 31 -pout/soong/.intermediates/hardware/interfaces/audio/aidl/android.hardware.audio.common_interface/4/preprocessed.aidl -pout/soong/.intermediates/hardware/interfaces/common/aidl/android.hardware.common_interface/2/preprocessed.aidl -pout/soong/.intermediates/hardware/interfaces/common/fmq/aidl/android.hardware.common.fmq_interface/1/preprocessed.aidl --ninja -d out/soong/.intermediates/hardware/interfaces/bluetooth/audio/aidl/android.hardware.bluetooth.audio-V5-ndk-source/gen/staging/android/hardware/bluetooth/audio/BroadcastCapability.cpp.d -h out/soong/.intermediates/hardware/interfaces/bluetooth/audio/aidl/android.hardware.bluetooth.audio-V5-ndk-source/gen/include/staging -o out/soong/.intermediates/hardware/interfaces/bluetooth/audio/aidl/android.hardware.bluetooth.audio-V5-ndk-source/gen/staging -Nhardware/interfaces/bluetooth/audio/aidl/aidl_api/android.hardware.bluetooth.audio/5 hardware/interfaces/bluetooth/audio/aidl/aidl_api/android.hardware.bluetooth.audio/5/android/hardware/bluetooth/audio/BroadcastCapability.aidl
 *
...
public:
  ...
  public:
    ...
    template <typename _Tp, typename = std::enable_if_t<
        _not_self<_Tp> &&
        std::is_constructible_v<std::variant<std::optional<std::vector<std::optional<::aidl::android::hardware::bluetooth::audio::Lc3Capabilities>>>, std::optional<std::vector<std::optional<::aidl::android::hardware::bluetooth::audio::BroadcastCapability::VendorCapabilities>>>>, _Tp>
      >>
  ...
  inline bool operator==(const BroadcastCapability& _rhs) const {
    return std::tie(codecType, supportedChannel, channelCountPerStream, leAudioCodecCapabilities, audioLocation) == std::tie(_rhs.codecType, _rhs.supportedChannel, _rhs.channelCountPerStream, _rhs.leAudioCodecCapabilities, _rhs.audioLocation);
  }
  inline bool operator<(const BroadcastCapability& _rhs) const {
    return std::tie(codecType, supportedChannel, channelCountPerStream, leAudioCodecCapabilities, audioLocation) < std::tie(_rhs.codecType, _rhs.supportedChannel, _rhs.channelCountPerStream, _rhs.leAudioCodecCapabilities, _rhs.audioLocation);
  }
