...
static const char* _g_aidl_android_hardware_audio_effect_IFactory_clazz_code_to_function[] = { "queryEffects","queryProcessing","createEffect","destroyEffect",};
static AIBinder_Class* _g_aidl_android_hardware_audio_effect_IFactory_clazz = ::ndk::ICInterface::defineClass(IFactory::descriptor, _aidl_android_hardware_audio_effect_IFactory_onTransact, _g_aidl_android_hardware_audio_effect_IFactory_clazz_code_to_function, 4);
...
::ndk::ScopedAStatus BpFactory::getInterfaceVersion(int32_t* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IFactory::getDefaultImpl()) {
    _aidl_status = IFactory::getDefaultImpl()->getInterfaceVersion(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpFactory::getInterfaceHash(std::string* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IFactory::getDefaultImpl()) {
    _aidl_status = IFactory::getDefaultImpl()->getInterfaceHash(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BnFactory::getInterfaceVersion(int32_t* _aidl_return) {
  *_aidl_return = IFactory::version;
  return ::ndk::ScopedAStatus(AStatus_newOk());
}
::ndk::ScopedAStatus BnFactory::getInterfaceHash(std::string* _aidl_return) {
  *_aidl_return = IFactory::hash;
  return ::ndk::ScopedAStatus(AStatus_newOk());
}
// Source for IFactory
...
::ndk::ScopedAStatus IFactoryDefault::getInterfaceVersion(int32_t* _aidl_return) {
  *_aidl_return = 0;
  return ::ndk::ScopedAStatus(AStatus_newOk());
}
::ndk::ScopedAStatus IFactoryDefault::getInterfaceHash(std::string* _aidl_return) {
  *_aidl_return = "";
  return ::ndk::ScopedAStatus(AStatus_newOk());
}
