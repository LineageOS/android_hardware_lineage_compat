...
static const char* _g_aidl_android_hardware_audio_effect_IEffect_clazz_code_to_function[] = { "open","close","getDescriptor","command","getState","setParameter","getParameter","reopen",};
static AIBinder_Class* _g_aidl_android_hardware_audio_effect_IEffect_clazz = ::ndk::ICInterface::defineClass(IEffect::descriptor, _aidl_android_hardware_audio_effect_IEffect_onTransact, _g_aidl_android_hardware_audio_effect_IEffect_clazz_code_to_function, 8);
...
::ndk::ScopedAStatus BpEffect::getInterfaceVersion(int32_t* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IEffect::getDefaultImpl()) {
    _aidl_status = IEffect::getDefaultImpl()->getInterfaceVersion(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpEffect::getInterfaceHash(std::string* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IEffect::getDefaultImpl()) {
    _aidl_status = IEffect::getDefaultImpl()->getInterfaceHash(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BnEffect::getInterfaceVersion(int32_t* _aidl_return) {
  *_aidl_return = IEffect::version;
  return ::ndk::ScopedAStatus(AStatus_newOk());
}
::ndk::ScopedAStatus BnEffect::getInterfaceHash(std::string* _aidl_return) {
  *_aidl_return = IEffect::hash;
  return ::ndk::ScopedAStatus(AStatus_newOk());
}
// Source for IEffect
...
::ndk::ScopedAStatus IEffectDefault::getInterfaceVersion(int32_t* _aidl_return) {
  *_aidl_return = 0;
  return ::ndk::ScopedAStatus(AStatus_newOk());
}
::ndk::ScopedAStatus IEffectDefault::getInterfaceHash(std::string* _aidl_return) {
  *_aidl_return = "";
  return ::ndk::ScopedAStatus(AStatus_newOk());
}
