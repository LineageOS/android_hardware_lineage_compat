...
namespace audio {
namespace eraser {
const char* ClassificationMetadataList::descriptor = "android.media.audio.eraser.ClassificationMetadataList";

binder_status_t ClassificationMetadataList::readFromParcel(const AParcel* _aidl_parcel) {
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &metadatas);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  AParcel_setDataPosition(_aidl_parcel, _aidl_start_pos + _aidl_parcelable_size);
  return _aidl_ret_status;
}
binder_status_t ClassificationMetadataList::writeToParcel(AParcel* _aidl_parcel) const {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, metadatas);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
