...
namespace audio {
namespace eraser {
const char* Configuration::descriptor = "android.media.audio.eraser.Configuration";

binder_status_t Configuration::readFromParcel(const AParcel* _aidl_parcel) {
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &classificationConfigs);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &maxClassificationMetadata);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
...
binder_status_t Configuration::writeToParcel(AParcel* _aidl_parcel) const {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, classificationConfigs);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, maxClassificationMetadata);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
