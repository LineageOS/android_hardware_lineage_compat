...
namespace audio {
namespace eraser {
const char* ClassificationMetadata::descriptor = "android.media.audio.eraser.ClassificationMetadata";

binder_status_t ClassificationMetadata::readFromParcel(const AParcel* _aidl_parcel) {
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &classification);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  AParcel_setDataPosition(_aidl_parcel, _aidl_start_pos + _aidl_parcelable_size);
  return _aidl_ret_status;
}
binder_status_t ClassificationMetadata::writeToParcel(AParcel* _aidl_parcel) const {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, classification);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
