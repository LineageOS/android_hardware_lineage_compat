...
namespace audio {
namespace core {
const char* VendorParameter::descriptor = "android.hardware.audio.core.VendorParameter";

binder_status_t VendorParameter::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t VendorParameter::writeToParcel(AParcel* _aidl_parcel) const {
