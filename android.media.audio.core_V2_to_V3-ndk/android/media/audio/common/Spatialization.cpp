...
namespace audio {
namespace common {
const char* Spatialization::descriptor = "android.media.audio.common.Spatialization";

binder_status_t Spatialization::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t Spatialization::writeToParcel(AParcel* _aidl_parcel) const {
