...
namespace audio {
namespace eraser {
const char* Classification::descriptor = "android.media.audio.eraser.Classification";

binder_status_t Classification::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t Classification::writeToParcel(AParcel* _aidl_parcel) const {
