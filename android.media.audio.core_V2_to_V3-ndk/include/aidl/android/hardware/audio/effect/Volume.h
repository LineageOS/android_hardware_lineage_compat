...
public:
  ...
  public:
    ...
    template <typename _Tp, typename = std::enable_if_t<
        _not_self<_Tp> &&
        std::is_constructible_v<std::variant<::aidl::android::hardware::audio::effect::VendorExtension, ::aidl::android::hardware::audio::effect::Volume::Tag>, _Tp>
      >>
  ...
  private:
    std::variant<::aidl::android::hardware::audio::effect::VendorExtension, ::aidl::android::hardware::audio::effect::Volume::Tag> _value;
  };
  // Expose tag symbols for legacy code
  static const inline Tag vendor = Tag::vendor;
  static const inline Tag levelDb = Tag::levelDb;
  static const inline Tag mute = Tag::mute;

  template<typename _Tp>
  static constexpr bool _not_self = !std::is_same_v<std::remove_cv_t<std::remove_reference_t<_Tp>>, Volume>;

  Volume() : _value(std::in_place_index<static_cast<size_t>(vendor)>, ::aidl::android::hardware::audio::effect::VendorExtension()) { }

  template <typename _Tp, typename = std::enable_if_t<
      _not_self<_Tp> &&
      std::is_constructible_v<std::variant<::aidl::android::hardware::audio::effect::VendorExtension, int32_t, bool>, _Tp>
    >>
  // NOLINTNEXTLINE(google-explicit-constructor)
  constexpr Volume(_Tp&& _arg)
      : _value(std::forward<_Tp>(_arg)) {}

  template <size_t _Np, typename... _Tp>
  constexpr explicit Volume(std::in_place_index_t<_Np>, _Tp&&... _args)
      : _value(std::in_place_index<_Np>, std::forward<_Tp>(_args)...) {}

  template <Tag _tag, typename... _Tp>
  static Volume make(_Tp&&... _args) {
    return Volume(std::in_place_index<static_cast<size_t>(_tag)>, std::forward<_Tp>(_args)...);
  }

  template <Tag _tag, typename _Tp, typename... _Up>
  static Volume make(std::initializer_list<_Tp> _il, _Up&&... _args) {
    return Volume(std::in_place_index<static_cast<size_t>(_tag)>, std::move(_il), std::forward<_Up>(_args)...);
  }
  ...
  inline bool operator==(const Volume& _rhs) const {
    return _value == _rhs._value;
  }
  inline bool operator<(const Volume& _rhs) const {
    return _value < _rhs._value;
  ...
  inline std::string toString() const {
    ...
    case levelDb: os << "levelDb: " << ::android::internal::ToString(get<levelDb>()); break;
    case mute: os << "mute: " << ::android::internal::ToString(get<mute>()); break;
    }
    os << "}";
    return os.str();
  }
...
namespace audio {
namespace effect {
[[nodiscard]] static inline std::string toString(Volume::Id::Tag val) {
  switch(val) {
  case Volume::Id::Tag::vendorExtensionTag:
    return "vendorExtensionTag";
  case Volume::Id::Tag::commonTag:
    return "commonTag";
  default:
...
template <>
constexpr inline std::array<aidl::android::hardware::audio::effect::Volume::Id::Tag, 2> enum_values<aidl::android::hardware::audio::effect::Volume::Id::Tag> = {
  aidl::android::hardware::audio::effect::Volume::Id::Tag::vendorExtensionTag,
  aidl::android::hardware::audio::effect::Volume::Id::Tag::commonTag,
};
...
namespace audio {
namespace effect {
[[nodiscard]] static inline std::string toString(Volume::Tag val) {
  switch(val) {
  case Volume::Tag::vendor:
    return "vendor";
  case Volume::Tag::levelDb:
    return "levelDb";
  case Volume::Tag::mute:
    return "mute";
  default:
    return std::to_string(static_cast<int32_t>(val));
  }
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template <>
constexpr inline std::array<aidl::android::hardware::audio::effect::Volume::Tag, 3> enum_values<aidl::android::hardware::audio::effect::Volume::Tag> = {
  aidl::android::hardware::audio::effect::Volume::Tag::vendor,
  aidl::android::hardware::audio::effect::Volume::Tag::levelDb,
  aidl::android::hardware::audio::effect::Volume::Tag::mute,
};
#pragma clang diagnostic pop
}  // namespace internal
}  // namespace ndk
