...
public:
  ...
  public:
    ...
    template <typename _Tp, typename = std::enable_if_t<
        _not_self<_Tp> &&
        std::is_constructible_v<std::variant<::aidl::android::hardware::audio::effect::VendorExtension, ::aidl::android::hardware::audio::effect::LoudnessEnhancer::Tag>, _Tp>
      >>
  ...
  private:
    std::variant<::aidl::android::hardware::audio::effect::VendorExtension, ::aidl::android::hardware::audio::effect::LoudnessEnhancer::Tag> _value;
  };
  // Expose tag symbols for legacy code
  static const inline Tag vendor = Tag::vendor;
  static const inline Tag gainMb = Tag::gainMb;

  template<typename _Tp>
  static constexpr bool _not_self = !std::is_same_v<std::remove_cv_t<std::remove_reference_t<_Tp>>, LoudnessEnhancer>;

  LoudnessEnhancer() : _value(std::in_place_index<static_cast<size_t>(vendor)>, ::aidl::android::hardware::audio::effect::VendorExtension()) { }

  template <typename _Tp, typename = std::enable_if_t<
      _not_self<_Tp> &&
      std::is_constructible_v<std::variant<::aidl::android::hardware::audio::effect::VendorExtension, int32_t>, _Tp>
    >>
  // NOLINTNEXTLINE(google-explicit-constructor)
  constexpr LoudnessEnhancer(_Tp&& _arg)
      : _value(std::forward<_Tp>(_arg)) {}

  template <size_t _Np, typename... _Tp>
  constexpr explicit LoudnessEnhancer(std::in_place_index_t<_Np>, _Tp&&... _args)
      : _value(std::in_place_index<_Np>, std::forward<_Tp>(_args)...) {}

  template <Tag _tag, typename... _Tp>
  static LoudnessEnhancer make(_Tp&&... _args) {
    return LoudnessEnhancer(std::in_place_index<static_cast<size_t>(_tag)>, std::forward<_Tp>(_args)...);
  }

  template <Tag _tag, typename _Tp, typename... _Up>
  static LoudnessEnhancer make(std::initializer_list<_Tp> _il, _Up&&... _args) {
    return LoudnessEnhancer(std::in_place_index<static_cast<size_t>(_tag)>, std::move(_il), std::forward<_Up>(_args)...);
  }
  ...
  inline bool operator==(const LoudnessEnhancer& _rhs) const {
    return _value == _rhs._value;
  }
  inline bool operator<(const LoudnessEnhancer& _rhs) const {
    return _value < _rhs._value;
  ...
  inline std::string toString() const {
    ...
    case gainMb: os << "gainMb: " << ::android::internal::ToString(get<gainMb>()); break;
    }
    os << "}";
    return os.str();
  }
...
namespace audio {
namespace effect {
[[nodiscard]] static inline std::string toString(LoudnessEnhancer::Id::Tag val) {
  switch(val) {
  case LoudnessEnhancer::Id::Tag::vendorExtensionTag:
    return "vendorExtensionTag";
  case LoudnessEnhancer::Id::Tag::commonTag:
    return "commonTag";
  default:
...
template <>
constexpr inline std::array<aidl::android::hardware::audio::effect::LoudnessEnhancer::Id::Tag, 2> enum_values<aidl::android::hardware::audio::effect::LoudnessEnhancer::Id::Tag> = {
  aidl::android::hardware::audio::effect::LoudnessEnhancer::Id::Tag::vendorExtensionTag,
  aidl::android::hardware::audio::effect::LoudnessEnhancer::Id::Tag::commonTag,
};
...
namespace audio {
namespace effect {
[[nodiscard]] static inline std::string toString(LoudnessEnhancer::Tag val) {
  switch(val) {
  case LoudnessEnhancer::Tag::vendor:
    return "vendor";
  case LoudnessEnhancer::Tag::gainMb:
    return "gainMb";
  default:
    return std::to_string(static_cast<int32_t>(val));
  }
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template <>
constexpr inline std::array<aidl::android::hardware::audio::effect::LoudnessEnhancer::Tag, 2> enum_values<aidl::android::hardware::audio::effect::LoudnessEnhancer::Tag> = {
  aidl::android::hardware::audio::effect::LoudnessEnhancer::Tag::vendor,
  aidl::android::hardware::audio::effect::LoudnessEnhancer::Tag::gainMb,
};
#pragma clang diagnostic pop
}  // namespace internal
}  // namespace ndk
