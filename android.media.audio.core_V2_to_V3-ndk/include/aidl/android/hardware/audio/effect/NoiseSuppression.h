...
public:
  ...
  public:
    ...
    template <typename _Tp, typename = std::enable_if_t<
        _not_self<_Tp> &&
        std::is_constructible_v<std::variant<::aidl::android::hardware::audio::effect::VendorExtension, ::aidl::android::hardware::audio::effect::NoiseSuppression::Tag>, _Tp>
      >>
  ...
  template <typename _Tp, typename = std::enable_if_t<
      _not_self<_Tp> &&
      std::is_constructible_v<std::variant<::aidl::android::hardware::audio::effect::VendorExtension, ::aidl::android::hardware::audio::effect::NoiseSuppression::Level, ::aidl::android::hardware::audio::effect::NoiseSuppression::Type>, _Tp>
    >>
  // NOLINTNEXTLINE(google-explicit-constructor)
