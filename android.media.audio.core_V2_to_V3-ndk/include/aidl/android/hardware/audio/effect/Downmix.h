...
public:
  ...
  public:
    ...
    template <typename _Tp, typename = std::enable_if_t<
        _not_self<_Tp> &&
        std::is_constructible_v<std::variant<::aidl::android::hardware::audio::effect::VendorExtension, ::aidl::android::hardware::audio::effect::Downmix::Tag>, _Tp>
      >>
  ...
  private:
    std::variant<::aidl::android::hardware::audio::effect::VendorExtension, ::aidl::android::hardware::audio::effect::Downmix::Tag> _value;
  };
  ...
  template<typename _Tp>
  static constexpr bool _not_self = !std::is_same_v<std::remove_cv_t<std::remove_reference_t<_Tp>>, Downmix>;

  Downmix() : _value(std::in_place_index<static_cast<size_t>(vendor)>, ::aidl::android::hardware::audio::effect::VendorExtension()) { }

  template <typename _Tp, typename = std::enable_if_t<
      _not_self<_Tp> &&
      std::is_constructible_v<std::variant<::aidl::android::hardware::audio::effect::VendorExtension, ::aidl::android::hardware::audio::effect::Downmix::Type>, _Tp>
    >>
  // NOLINTNEXTLINE(google-explicit-constructor)
  constexpr Downmix(_Tp&& _arg)
      : _value(std::forward<_Tp>(_arg)) {}

  template <size_t _Np, typename... _Tp>
  constexpr explicit Downmix(std::in_place_index_t<_Np>, _Tp&&... _args)
      : _value(std::in_place_index<_Np>, std::forward<_Tp>(_args)...) {}

  template <Tag _tag, typename... _Tp>
  static Downmix make(_Tp&&... _args) {
    return Downmix(std::in_place_index<static_cast<size_t>(_tag)>, std::forward<_Tp>(_args)...);
  }

  template <Tag _tag, typename _Tp, typename... _Up>
  static Downmix make(std::initializer_list<_Tp> _il, _Up&&... _args) {
    return Downmix(std::in_place_index<static_cast<size_t>(_tag)>, std::move(_il), std::forward<_Up>(_args)...);
  }
  ...
  inline bool operator==(const Downmix& _rhs) const {
    return _value == _rhs._value;
  }
  inline bool operator<(const Downmix& _rhs) const {
    return _value < _rhs._value;
...
private:
  std::variant<::aidl::android::hardware::audio::effect::VendorExtension, ::aidl::android::hardware::audio::effect::Downmix::Type> _value;
};
}  // namespace effect
}  // namespace audio
}  // namespace hardware
...
namespace audio {
namespace effect {
[[nodiscard]] static inline std::string toString(Downmix::Id::Tag val) {
  switch(val) {
  case Downmix::Id::Tag::vendorExtensionTag:
    return "vendorExtensionTag";
  case Downmix::Id::Tag::commonTag:
    return "commonTag";
  default:
...
template <>
constexpr inline std::array<aidl::android::hardware::audio::effect::Downmix::Id::Tag, 2> enum_values<aidl::android::hardware::audio::effect::Downmix::Id::Tag> = {
  aidl::android::hardware::audio::effect::Downmix::Id::Tag::vendorExtensionTag,
  aidl::android::hardware::audio::effect::Downmix::Id::Tag::commonTag,
};
...
namespace audio {
namespace effect {
[[nodiscard]] static inline std::string toString(Downmix::Type val) {
  switch(val) {
  case Downmix::Type::STRIP:
    return "STRIP";
  case Downmix::Type::FOLD:
    return "FOLD";
  default:
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template <>
constexpr inline std::array<aidl::android::hardware::audio::effect::Downmix::Type, 2> enum_values<aidl::android::hardware::audio::effect::Downmix::Type> = {
  aidl::android::hardware::audio::effect::Downmix::Type::STRIP,
  aidl::android::hardware::audio::effect::Downmix::Type::FOLD,
};
#pragma clang diagnostic pop
}  // namespace internal
}  // namespace ndk
...
namespace audio {
namespace effect {
[[nodiscard]] static inline std::string toString(Downmix::Tag val) {
  switch(val) {
  case Downmix::Tag::vendor:
    return "vendor";
  case Downmix::Tag::type:
    return "type";
  default:
    return std::to_string(static_cast<int32_t>(val));
  }
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template <>
constexpr inline std::array<aidl::android::hardware::audio::effect::Downmix::Tag, 2> enum_values<aidl::android::hardware::audio::effect::Downmix::Tag> = {
  aidl::android::hardware::audio::effect::Downmix::Tag::vendor,
  aidl::android::hardware::audio::effect::Downmix::Tag::type,
};
#pragma clang diagnostic pop
}  // namespace internal
}  // namespace ndk
