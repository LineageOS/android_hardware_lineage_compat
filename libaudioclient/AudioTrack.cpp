...
extern "C" void orig(audio_stream_type_t streamType, uint32_t sampleRate, audio_format_t format,
...
extern "C" void newfnc(audio_stream_type_t streamType, uint32_t sampleRate, audio_format_t format,
                       audio_channel_mask_t channelMask, size_t frameCount,
                       ...
                       const audio_attributes_t* pAttributes, bool doNotReconnect,
                       float maxRequiredSpeed, audio_port_handle_t selectedDeviceId) {
    orig(streamType, sampleRate, format, channelMask, frameCount, flags,
         createCallback(callback, user), notificationFrames, sessionId, transferType, offloadInfo,
